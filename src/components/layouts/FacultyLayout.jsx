// src/components/layouts/FacultyLayout.jsx
...
const FacultyLayout = () => {
  ...
  const getCurrentPage = () => {
    ...
    if (pathParts[2] === "student" && pathParts[3]) {
  ...
  const userId = user?.id || `faculty-${facultyData.id}` || "faculty-001";
    ...
    <div className="min-h-screen bg-[rgb(var(--background))] text-[rgb(var(--foreground))]">
      <div className="flex h-screen overflow-hidden">
        <Sidebar
          ...
          userRole="faculty"
          userName={user?.name || facultyData.name}
          userEmail={user?.email || facultyData.email}
        />
        ...
        <div className="flex-1 flex flex-col overflow-hidden transition-all duration-300">
          <Navbar
            ...
            setSidebarOpen={setSidebarOpen}
            studentName={user?.name || facultyData.name}
            userRole="faculty"
            userId={userId}
            navigate={handleNavigate}
          />
